  ...
  return (
    <>
      <div className="relative border-1 border-solid fondo6 h-screen">
        ...
        <div
          className="border-2 w-[24pc] sm:w-[67pc] blu text-[0.6pc] sm:text-[1pc] px-4 py-1 z-40 absolute right-[1%] sm:right-[11pc] top-[0pc] sm:top-[4pc]"
        ...
        >
          ...
          <p>Autor: Esopo Adaptación Jennifer Mendoza Y Merlyn Luque</p>
        </div>
      </div>
    </>
  );
