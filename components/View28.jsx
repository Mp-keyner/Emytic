  ...
  return (
    <>
      <div className="relative border-1 border-solid fondo4 h-screen">
        ...
        <div
          className="border-2 blu w-[24pc] text-lg px-4 py-1 z-40 absolute  left-[16%] top-[25%]"
        ...
        <div
          className="border-2 blu w-[24pc] text-lg px-4 py-1 z-40 absolute  left-[16%] top-[58%]"
          data-aos="fade-right" // Definición única de data-aos
          data-aos-out="fade-left"
          id="mensaje"
          style={{ transform: "translate(-50%, -50%)" }}
