    ...
    <div className="h-screen fondoMap relative second">
      ...
      >
        <div className="bocadillo-cuadrado-mobile1 ">
          <p>
            Amiguitos hemos llegado a la <b>región Amazonas</b>, el hogar de
            muchas especies, una casa verde y majestuosa, ubicada al sur de
            nuestro país Colombia, y bañada del río amazonas, Vamos a conocer a
            Timi la mona Titi
          </p>
        </div>
      </div>
