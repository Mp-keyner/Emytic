  ...
  return (
    <>
      <div className="relative border-1 border-solid border-red-500 bg-red-400 h-screen">
        ...
        <div
          className="border-2 border-red-500 w-[44pc] text-lg px-4 py-1 z-40 absolute bg-white text-black mess right-[11pc] top-[5%]"
        ...
        <Image
          className="w-[11pc] border-2 border-red-500 absolute left-[0pc] bottom-[0pc]"
