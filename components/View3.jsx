...
const View1 = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="absolute top-[2pc] z-50 left-[0pc] w-[10pc] flex flex-col items-center text-center "
          data-aos-delay="1500"
        ...
        <div
          className="z-40 absolute left-[38%] sm:left-[15pc] top-[81%] sm:top-[23pc]"
          data-aos="fade-right"
        >
        ...
        <div
          className="z-40 absolute  top-[23%] right-[4%] sm:right-[22%] sm:top-[3pc] w-[40pc]"
          data-aos="fade-right"
          data-aos-delay="500"
        >
