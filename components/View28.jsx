  ...
  return (
    <>
      <div className="relative border-1 border-solid border-red-500 bg-blue-400 h-screen">
        ...
        <div
          className="border-2 border-red-500 w-[24pc] text-lg px-4 py-1 z-40 absolute bg-white text-black mess left-[16%] top-[25%]"
        ...
        <div
          className="border-2 border-red-500 w-[24pc] text-lg px-4 py-1 z-40 absolute bg-white text-black mess left-[16%] top-[58%]"
          data-aos="fade-right" // Definición única de data-aos
          data-aos-out="fade-left"
          id="mensaje"
          style={{ transform: "translate(-50%, -50%)" }}
        ...
        <Image
          className="w-[17pc] border-2 z-40 border-red-500 absolute left-[0pc] bottom-[-2.3pc]"
        ...
        />
        <Image
          className="w-[35pc] border-2 z-40 border-red-500 absolute left-[50%] top-[50%]"
          data-aos="fade-left" // Definición única de data-aos
          data-aos-out="fade-left"
