...
const Sopa = () => {
    useEffect(() => {
        ...
        script.src = 'https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js'; // URL del script
        script.async = true; // Cargar de manera asincrónica
        script.type = 'text/javascript'; // Tipo de script

        // Agregar el script al documento
        document.head.appendChild(script);

        // Función de limpieza para eliminar el script cuando el componente se desmonta
        return () => {
            document.head.removeChild(script);
        };
    }, []); // El segundo argumento vacío asegura que se cargue solo una vez


    var words = ['keyner', 'cursos', 'ayuda', 'oswaldo', 'Tutoriales', 'Plugins'];
